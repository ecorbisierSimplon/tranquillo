...
use App\Repository\TpaAuthUsersRepository;
...
#[ORM\Entity(repositoryClass: TpaAuthUsersRepository::class)]
#[ORM\Table(name: "tpa_users")]
class TpaAuthUsers implements UserInterface, PasswordAuthenticatedUserInterface
{
