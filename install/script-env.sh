...
JWT_PASSPHRASE=6fb9e303fde3ca64049df4c724a6d1c34ad2d3080450b0eeb8fad7778b29af31
###< lexik/jwt-authentication-bundle ###
...
DATABASE_URL="mysql://\${MYSQL_USER_API}:\${MYSQL_PASSWORD_API}@\${MYSQL_LOCALHOST}:\${SQL_LOCALHOST_PORT}/\${MYSQL_DATABASE}?serverVersion=\${MARIADB_VERSION}-MariaDB&charset=utf8mb4"
###< doctrine/doctrine-bundle ###
...
JWT_SECRET_KEY=%kernel.project_dir%/config/jwt/private.pem
JWT_PUBLIC_KEY=%kernel.project_dir%/config/jwt/public.pem
JWT_PASSPHRASE=< le mot de passe à changer >
###< lexik/jwt-authentication-bundle ###
