 ...
 */
final class Version20240416163837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_A175781E67B3B43D ON tpa_tasks (users_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A175781E67B3B43D ON tpa_tasks');
